...
learning_english = {'Family':                   {'Grandfather':'Abuelo', 'Grandmother':'Abuela', 'Father':'Padre', 'Mother':'Madre', 'Dad':'Papa', 'Mom':'Mama', 'Uncle':'Tio', 'Aunt':'Tia', 'Brother':'Hermano', 'Sister':'Hermana', 'Son':'Hijo', 'Daughter':'Hija', 'Grandchildren':'Nieto', 'Grandson':'Nieto', 'Granddaughter':'Nieta', 'Children':'Hijo', 'Father In Law':'Suegro', 'Mother In Law':'Suegra', 'Stepfather':'Padrastro', 'Stepmother':'Madrastra', 'Husband':'Esposo', 'Wife':'Esposa', 'Nephew':'Sobrino', 'Niece':'Sobrina', 'Half Brother':'Medio Hermano', 'Half Sister':'Media Hermana', 'Stepson':'Hijastro', 'Stepdaughter':'Hijastra', 'Cousin':'Primo', 'Son In Law':'Yerno', 'Daughter In Law':'Nuera'},
                    ...
                    'Emotions':                 {'Happy':'Feliz', 'Cheerful':'Alegre', 'Joyful':'Jubiloso', 'Happiness':'Alegria', 'Glad':'Contento', 'Interested':'Interesado', 'Proud':'Orgulloso', 'Powerful':'Poderoso', 'Optimistic':'Optimista', 'Pride':'Orgullo', 'Gratitude':'Gratitud', 'Hope':'Esperanza', 'Empathy':'Empatia', 'Curiosity':'Curiosidad', 'Sympathy':'Simpatia', 'Nostalgia':'Nostalgia', 'Relief':'Alivio', 'Serenity':'Serenidad', 'Euphoria':'Euforia', 'Admiration':'Admiracion', 'Affection':'Afecto', 'Attraction':'Atraccion', 'Love':'Amor', 'Heartbreak':'Desamor', 'In Love':'Enamorado', 'Excited':'Emocionado', 'Trust':'Confianza', 'Distrust':'Desconfianza', 'Fear':'Miedo', 'Fearful':'Miedoso', 'Scared':'Asustado', 'Alarmed':'Alarmado', 'Frightened':'Aterrado', 'Spooked':'Espantado', 'Nervous':'Nervioso', 'Worry':'Preocupacion', 'Anxiety':'Ansiedad', 'Anxious':'Ansioso', 'Insecure':'Inseguro', 'Anger':'Ira', 'Angry':'Enojado', 'Rage':'Furia', 'Furious':'Furioso', 'Annoyed':'Irritado', 'Mad':'Enfadado', 'Aggressive':'Agresivo', 'Hate':'Odio', 'Sad':'Triste', 'Sadness':'Tristeza', 'Guilty':'Culpable', 'Abandoned':'Abandonado', 'Depressed':'Deprimido', 'Lonely':'Solitario', 'Bored':'Aburrido', 'Ashamed':'Apenado', 'Unhappy':'Infeliz', 'Miserable':'Miserable', 'Dissappointment':'Decepcion', 'Upset':'Decepcionado', 'Frustration':'Frustracion', 'Frustrated':'Frustrado', 'Pain':'Dolor', 'Thoughtful':'Pensativo', 'Disgust':'Asco', 'Shame':'Verguenza', 'Jealousy':'Celos', 'Envy':'Envidia', 'Surprised':'Sorprendido', 'Shocked':'Impactado', 'Confusion':'Confusion', 'Confused':'Confundido', 'Doubt':'Duda', 'Doubtful':'Dudoso'},
                    'Personality Traits':       {'Kind': 'Amable', 'Friendly': 'Amigable',  'Empathetic':'Empatico', 'Amusing':'Divertido', 'Sympathetic':'Simpatico', 'Funny':'Gracioso', 'Sincere':'Sincero', 'Honest':'Honesto', 'Gentle':'Amable', 'Coherent':'Coherente', 'Responsible':'Responsable', 'Hardworking':'Trabajador', 'Polite':'Educado', 'Respectful':'Respetuoso', 'Generous':'Generoso', 'Fair':'Justo', 'Patient':'Paciente', 'Impatient':'Impaciente', 'Calm':'Tranquilo', 'Cautious':'Cauteloso', 'Optimistic':'Optimista', 'Pessimistic':'Pesimista', 'Loyal':'Leal', 'Disloyal':'Desleal', 'Creative':'Creativo', 'Intelligent':'Inteligente', 'Brave':'Valiente', 'Perseverant':'Perseverante', 'Charming':'Encantador', 'Passionate':'Apasionado', 'Clever':'Listo', 'Cunning':'Astuto', 'Confident':'Confiado', 'Suspicious':'Sospechoso', 'Hearty':'Coordial', 'Helpful':'Servicial', 'Humble':'Humilde', 'Modest':'Modesto', 'Saucy':'Atrevido', 'Sneering':'Burlon', 'Witty':'Ingenioso', 'Extroverted':'Extrovertido', 'Introverted':'Introvertido', 'Tidy':'Ordenado', 'Messy':'Desordenado', 'Arrogant':'Arrogante', 'Selfish':'Egoista', 'Bitchy':'Malvado', 'Boring':'Aburrido', 'Bossy':'Mandon', 'Stubborn':'Terco', 'Cheeky':'Descarado', 'Clumsy':'Torpe', 'Competitive':'Competitivo', 'Conceited':'Vanidoso', 'Cruel':'Cruel', 'Cynical':'Cinico', 'Dishonest':'Deshonesto', 'Disrespectul':'Irrespetuoso', 'Dominant':'Dominante', 'Dowdy':'Desaliñado', 'Eccentric':'Excentrico', 'Envious':'Envidioso', 'Foolish':'Necio', 'Fussy':'Exigente', 'Impulsive':'Impulsivo', 'Insolent':'Insolente', 'Lazy':'Perezoso', 'Moody':'Malhumorado', 'Manipulative':'Manipulador', 'Naive':'Ingenuo', 'Obsessive':'Obsesivo', 'Obstinate':'Obstinado', 'Materialistic':'Materialista', 'Restless':'Inquieto', 'Rude':'Grosero', 'Shy':'Timido', 'Spiteful':'Rencoroso', 'Stingy':'Tacaño', 'Strict':'Estricto', 'Vain':'Presumido', 'Vindictiv':'Vengativo', 'Sarcastic':'Sarcastico'},
                    'Parts of the Body':        {'Head': 'Cabeza', 'Eye': 'Ojo', 'Nose':'Nariz', 'Tooth':'Diente', 'Neck':'Cuello', 'Arm':'Brazo', 'Finger':'Dedo', 'Knee':'Rodilla', 'Back':'Espalda', 'Face':'Cara', 'Ear':'Oreja', 'Mouth':'Boca', 'Tongue':'Lengua', 'Shoulder':'Hombro', 'Hand':'Mano', 'Leg':'Pierna', 'Foot':'Pie', 'Stomach':'Estomago', 'Forehead':'Frente', 'Chin':'Menton', 'Wrist':'Muñeca', 'Chest':'Pecho', 'Hip':'Cadera', 'Heel':'Talon', 'Skin':'Piel', 'Bone':'Hueso', 'Lung':'Pulmon', 'Blood':'Sangre', 'Cheek':'Mejilla', 'Lip':'Labio', 'Elbow':'Codo', 'Waist':'Cintura', 'Ankle':'Tobillo', 'Nail':'Uña', 'Muscle':'Musculo', 'Heart':'Corazon', 'Liver':'Higado', 'Brain':'Cerebro', 'Nerve':'Nervio', 'Digestive System':'Sistema Digestivo', 'Circulatory System':'Sistema Circulatorio', 'Intestine':'Intestino', 'Tissue':'Tejido', 'Cell':'Celula', 'Neuron':'Neurona', 'Vein':'Vena', 'Pectorals':'Pectorales', 'Abdomen':'Adbomen', 'Biceps':'Biceps', 'Triceps':'Triceps', 'Spinal Cord':'Medula Espinal', 'Nervous System':'Sistema Nervioso', 'Kidney':'Riñon', 'Joint':'Articulacion', 'Organ':'Organo', 'Membrane':'Membrana', 'Neural Network':'Red Neuronal', 'Hair':'Cabello', 'Eyebrow':'Ceja', 'Eyelash':'Pestaña' },
                    'Clothes and Shoes':        {'Clothes': 'Ropa', 'Underwear': 'Ropa Interior', 'Shirt':'Camisa', 'T-Shirt':'Camiseta', 'Pants':'Pantalones', 'Jeans':'Jeans', 'Dress':'Vestido', 'Skirt':'Falda', 'Sweater':'Sueter', 'Jacket':'Chaqueta', 'Coat':'Abrigo', 'Socks':'Medias', 'Blouse':'Blusa', 'Vest':'Chaleco', 'Tie':'Corbata', 'Hat':'Sombrero', 'Belt':'Cinturon', 'Pajama':'Pijama', 'Hoodie':'Sudadera', 'Suit':'Traje', 'Scarf':'Bufanda', 'Cap':'Gorra', 'Gloves':'Guantes', 'Swimsuit':'Traje De Baño', 'Shoes':'Zapatos', 'Sandals':'Sandalias', 'Dress Shoes':'Zapatos Formales', 'Slippers':'Pantuflas', 'Sneakers':'Tenis', 'Boots':'Botas', 'High Heels':'Tacones'  },
                    'Parts of the House':       {'House': 'Casa', 'Home': 'Hogar', 'Room':'Habitacion', 'Bedroom':'Dormitorio', 'Bathroom':'Baño', 'Kitchen':'Cocina', 'Living Room':'Sala', 'Dining Room':'Comedor', 'Door':'Puerta', 'Window':'Ventana', 'Floor':'Piso', 'Wall':'Pared', 'Roof':'Techo', 'Study Room':'Cuarto De Estudio', 'Apartment':'Apartamento', 'Hall':'Pasillo', 'Entrance':'Entrada', 'Stairs':'Escaleras', 'Balcony':'Balcon', 'Garage':'Garaje', 'Garden':'Jardin', 'Yard':'Patio', 'Ceiling':'Techo Interior', 'Sink':'Lavamanos', 'Shower':'Ducha', 'Toilet':'Inodoro', 'Closet':'Armario', 'Cupboard':'Alacena', 'Basement':'Sotano', 'Attic':'Atico', 'Laundry Room':'Lavanderia', 'Guest Room':'Habitacion De Invitados', 'Gate':'Porton', 'Fireplace':'Chimenea', 'Light Switch':'Interruptor', 'Socket':'Enchufe', 'Lock':'Cerradura', 'Handle':'Manija', 'Tile':'Baldosa', 'Carpet':'Alfombra' },
